function [r,j,f] = get_element_stiffness(x0,x,h,f0,ue,flg,mmax,e) 
% Inputs
...
% f   -  element forcings at the current Newton iteration
    ...
    %% Initialization
    global t TimeIntPar matProp modelPar v_BC N egv
    mide = round(N.elem/2);
    ...
    if e==mide             %Middle element
        ...
        k.Tv = zeros(2,2);
        k.gv = zeros(1,2);
        mm = blkdiag(m.v,m.s,m.T,m.g);
        kk = [k.vv k.vs k.vT k.vg;
              k.sv G.ss G.sT G.sg;
